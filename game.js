...
mainState.preload = function preload() {
    game.load.image('player', 'assets/parrot.png')
    game.load.image('bonus', 'assets/boxItem.png')
    game.load.image('bubble', 'assets/bubble4.png')
    game.load.image('water', 'assets/waterTop_low.png')
    game.load.image('coin', 'assets/coinGold.png')
    game.load.image('hudcoin', 'assets/hudCoin.png')
    game.load.image('background', 'assets/blue_land.png')
    game.load.image('plane', 'assets/planeYellow1.png')
    game.load.image('box', 'assets/boxCoin_boxed.png')
}
